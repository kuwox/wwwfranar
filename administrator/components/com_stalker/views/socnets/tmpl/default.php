...
<div id="editcell">
    ...
    <thead>
        <tr>
	        ...
	        <th class="sortable">
	        	<?php echo JHTML::_('grid.sort', JText::_('URL'), 'url', $this->lists['order_Dir'], $this->lists['order']); ?>
	        </th>
	        <th class="sortable">
...
<?php
    ...
    for ($i=0, $n=count($this->items); $i < $n; $i++)
    {
		...
		$link 		= JRoute::_('index.php?option=com_stalker&controller=socnet&task=edit&cid[]='. $row->id);
...
<input type="hidden" name="view" value="socnets" />
