...
(function() {
	...
	tinymce.create('tinymce.plugins.AdvListPlugin', {
		init : function(ed, url) {
			...
			var nl = ed.getParam("advlist_number_styles", "default,lower-alpha,lower-greek,lower-roman,upper-alpha,upper-roman"), bl = ed.getParam("advlist_bullet_styles", "default,circle,disc,square");

			t.numlist = typeof(nl) == 'string' ? buildFormats(nl) : nl;
			t.bullist = typeof(bl) == 'string' ? buildFormats(bl) : bl;
		},
